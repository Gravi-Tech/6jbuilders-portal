<template>
  <div class="about-us">
    <v-parallax src="https://th.bing.com/th/id/OIP.1fnhZ9plz0-a9Hx-tGTNDQHaEU?w=297&h=180&c=7&r=0&o=5&dpr=2&pid=1.7" height="400">
    ...
    <v-container class="my-12">
      <v-row class="flex-row">
        ...
        <v-col cols="12" sm="4">
          ...
          <p class="text-center">
            Our vision is to be a leading construction company recognized for innovation, excellence, and commitment
        ...
        <v-col cols="12" sm="4">
          ...
          <p class="text-center">
            We aim to establish lasting relationships with our clients based on trust and integrity. We strive to
            continuously improve our processes, invest in our team, and contribute positively to the communities we serve.
          </p>
        </v-col>
      </v-row>
    </v-container>
